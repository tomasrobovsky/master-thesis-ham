...
Companion repository for the Master's thesis **"Heterogeneous Agent Modelling in Traditional Finance vs. Crypto Markets: Does One Model Rule Them All?"** (Charles University, IES FSV, 2026).
